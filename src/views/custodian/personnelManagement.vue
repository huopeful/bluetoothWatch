  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.address')" min-width="150px">
       ...
       <el-table-column :label="$t('table.personnelManagement.areaCode')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.areaCode }}</span>
        </template>
      </el-table-column>
       <el-table-column :label="$t('table.personnelManagement.roomNumber')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.roomNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.personnelManagement.accusation')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.accusation }}</span>
        </template>
      </el-table-column>
     ...
     <!--  <el-table-column :label="$t('table.currentHeartRate')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.currentHeartRate }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.currentBloodRate')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.currentBloodRate }}</span>
        </template>
      </el-table-column>
 -->
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('table.sex')" prop="sex">
          <el-select v-model="temp.sex" class="filter-item" placeholder="Please select">
            <el-option v-for="item in calendarTypeOptions" :key="item.sex" :label="item.sex" :value="item.sex" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item :label="$t('table.personnelManagement.areaCode')" prop="deviceNumber">
          <el-input v-model="temp.areaCode" />
        </el-form-item>
        <el-form-item :label="$t('table.personnelManagement.roomNumber')" prop="phoneNumber">
          <el-input v-model="temp.roomNumber" />
        </el-form-item>
        <el-form-item :label="$t('table.personnelManagement.accusation')" prop="address">
          <el-input v-model="temp.accusation" />
        </el-form-item>
...
//import { createArticle } from '@/api/health'
