  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.address')" min-width="150px">
       ...
       <el-table-column :label="$t('table.timingRollCall.rollCall')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.display_time }}</span>
        </template>
      </el-table-column>
       <el-table-column :label="$t('table.timingRollCall.remark')" width="110px" align="center">
        <template slot-scope="scope">
 ...
 -->
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="$t('table.timingRollCall.rollCall')" prop="rollCall">
          <el-input v-model="temp.display_time" />
        </el-form-item>
        <el-form-item :label="$t('table.timingRollCall.remark')" prop="remark">
