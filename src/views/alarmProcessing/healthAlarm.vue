  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.healthWarning.state')" min-width="150px" align="center">
        <template slot-scope="scope">
          <!-- 1为正在报警  2为报警预停止 -->
          <span v-if="scope.row.opinion == 0" class="red">正在报警</span>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item :label="$t('table.date')" prop="timestamp">
          <el-date-picker v-model="temp.timestamp" type="datetime" placeholder="请输入时间"/>
        </el-form-item>
    ...
    <el-dialog :visible.sync="dialogJBVisible" title="处理报警">
      ...
      >
        ...
        <el-form-item
          label-width="80px"
          :label="$t('table.healthWarning.operator')"
          prop="operator"
        >
  ...
  methods: {
    ...
    screenHealthAlarmData(data) {
      for (var i = 0; i < data.length; i++) {
        if (data[i].exceptionType !== 4 && data[i].exceptionType !== 0) {
