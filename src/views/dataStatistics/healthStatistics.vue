    ...
    >
      ...
      <el-table-column :label="$t('table.healthStatusText')" align="center" width="150">
        <template slot-scope="scope">
          ...
          <!-- <span :class="{'red':healthStatus==1}">{{ scope.row.healthStatusText }}</span> -->
          <!-- 1为不健康  2健康 -->
      ...
      >
        <template slot-scope="{row}">
          ...
          <!-- <el-button size="small" v-waves type="danger" @click="untying(row)">删除</el-button> -->
        </template>
      </el-table-column>
    </el-table>
      ...
      >
        ...
        <el-form-item :label="$t('table.address')" prop="address">
         ...
         <el-form-item :label="$t('table.status')">
          <el-select v-model="temp.healthStatusText" class="filter-item" placeholder="Please select">
