<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.untying.date')" width="150px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.untying.reason')" min-width="150px">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label-width='80px' :label="$t('table.name')" prop="name">
          <el-input v-model="temp.name"/>
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('table.sex')" prop="sex">
        ...
        <el-form-item label-width='80px' :label="$t('table.IDNum')" prop="IDNum">
          <el-input v-model="temp.IDNum"/>
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('table.deviceNumber')" prop="deviceNumber">
          <el-input v-model="temp.deviceNumber"/>
          <!-- <el-input type="textarea" :rows="2" v-model="temp.deviceNumber"/> -->
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('table.untying.date')" prop="timestamp">
          <el-date-picker
        ...
        <el-form-item label-width='80px' :label="$t('table.phoneNumber')" prop="phoneNumber">
          <el-input v-model="temp.phoneNumber"/>
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('table.untying.reason')" prop="address">
    ...
    <el-dialog :visible.sync="dialogJBVisible" title="解除绑定">
      <el-form
        ...
        style="width: 400px; margin-left:50px;"
      >
        <el-form-item label-width='80px' :label="$t('untying.time')" prop="time">
          <el-date-picker
        ...
        <el-form-item label-width='80px' :label="$t('untying.reason')" prop="reason">
          <el-input type="textarea" :rows="2" v-model="untyingData.reason"/>
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('untying.operator')" prop="operator">
  ...
  data() {
    return {
      ...
      untyingRules: {
        ...
        reason: [{ required: true, message: '解绑事由不能为空', trigger: 'blur' }],
      },
    };
  },
  created() {
