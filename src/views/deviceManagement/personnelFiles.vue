<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.personnel.heartRate')" width="110px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.heartRate }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.personnel.bloodPressure')" width="110px" align="center">
        <template slot-scope="scope">
