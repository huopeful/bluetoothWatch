<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.earlyWarning.state')" min-width="150px">
        <template slot-scope="scope">
          <!-- 1为正在报警  2为报警预停止 -->
    ...
    <el-dialog :visible.sync="dialogJBVisible" title="处理报警">
      <el-form
        ...
        style="width: 400px; margin-left:50px;"
      >
        <el-form-item label-width='80px' :label="$t('table.earlyWarning.date')" prop="time">
          <el-date-picker
        ...
        <el-form-item label-width='80px' :label="$t('table.earlyWarning.reason')" prop="reason">
          <el-input type="textarea" :rows="2" v-model="untyingData.reason"/>
        </el-form-item>
        <el-form-item label-width='80px' :label="$t('table.earlyWarning.operator')" prop="operator">
