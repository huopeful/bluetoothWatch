<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.currentBloodRateLow')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.lowblood }}</span>
        </template>
      </el-table-column>
       <el-table-column :label="$t('table.currentBloodRateHigh')" width="150px" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.highblood }}</span>
        </template>
      </el-table-column>
